...
/**
 * Exception handler ONLY for Gateway's own controllers (AuthController)
 * Downstream service errors are automatically propagated by Spring Cloud
 * Gateway
 */
@Slf4j
...
public class GatewayControllerExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
        log.error("Unexpected exception in gateway controller: ", ex);
