...
import com.facsciencesuy1.planning_management.academic_service.utils.components.SecurityFilter;
	...
	SecurityFilterChain publicFilterChain(HttpSecurity http,
		...
		return http
				...
				.authorizeHttpRequests(authorize -> authorize
						.requestMatchers("/api/ues/**", "/api/rooms/**", "/api/courses/**", "/api/faculties/**",
								"/api/levels/**")
						.denyAll())
