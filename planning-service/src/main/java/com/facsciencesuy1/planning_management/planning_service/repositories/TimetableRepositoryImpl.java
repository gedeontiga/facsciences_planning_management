...
// findByAcademicYearAndSessionTypeAndUsedTrueAndLevelBranchId(
// String academicYear, SessionType sessionType, String branchId, Pageable
// pageable) {
...
// TypedAggregation<Timetable> dataAggregation =
// Aggregation.newAggregation(Timetable.class, dataPipeline);
// List<Timetable> content = mongoTemplate.aggregate(dataAggregation,
// Timetable.class).getMappedResults();
...
// Aggregation.newAggregation(CountResult.class,
// countPipeline);
