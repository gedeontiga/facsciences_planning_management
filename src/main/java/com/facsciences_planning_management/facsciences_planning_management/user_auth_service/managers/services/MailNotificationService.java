...
public class MailNotificationService {
    ...
    public void sendAccountCreationEmail(String email, String firstName, String defaultPassword, String role) {
        try {
            ...
            String loginLink = getFrontendUrl() + "/login";
    ...
    private String buildAccountCreationEmailContent(String firstName, String email, String defaultPassword, String role,
        ...
        return "<!DOCTYPE html>" +
                ...
                "<h1 style='color: #5f33d5; margin: 0; font-size: 24px;'>Faculté des Sciences UY1</h1>" +
                ...
                +
                "<div style='background-color: #f9f9f9; padding: 20px; border-radius: 6px; margin: 25px 0; border-left: 4px solid #5f33d5;'>"
                +
                "<h3 style='margin-top: 0; color: #5f33d5;'>Vos informations de connexion :</h3>" +
                ...
                "<a href='" + loginLink + "' style='display: inline-block; background-color: #5f33d5; color: white; " +
                ...
                "<a href='" + loginLink + "' style='color: #5f33d5; word-break: break-all;'>" + loginLink + "</a>" +
                "</p>" +
