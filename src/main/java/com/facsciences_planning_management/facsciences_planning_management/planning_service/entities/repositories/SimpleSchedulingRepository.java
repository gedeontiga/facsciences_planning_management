...
@Repository
public interface SimpleSchedulingRepository extends SchedulingBaseRepository<SimpleScheduling, String> {

	List<SimpleScheduling> findByTeacherId(String teacherId);

	List<SimpleScheduling> findByDay(DayOfWeek day);

	List<SimpleScheduling> findByRoomIdAndDayAndStartTimeGreaterThanEqualAndStartTimeLessThan(
			String roomId, DayOfWeek day, LocalTime start, LocalTime end);

	List<SimpleScheduling> findByRoomIdAndDayAndEndTimeGreaterThanAndEndTimeLessThanEqual(
			String roomId, DayOfWeek day, LocalTime start, LocalTime end);

	List<SimpleScheduling> findByRoomIdAndDayAndStartTimeLessThanEqualAndEndTimeGreaterThanEqual(
			String roomId, DayOfWeek day, LocalTime start, LocalTime end);

	default List<SimpleScheduling> findConflicts(String roomId, LocalTime startTime, LocalTime endTime,
			DayOfWeek day) {
