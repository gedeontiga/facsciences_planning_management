...
// import
// com.facsciences_planning_management.facsciences_planning_management.planning_service.entities.CourseScheduling;
// import
// com.facsciences_planning_management.facsciences_planning_management.planning_service.entities.types.TimeSlot;
// import
// com.facsciences_planning_management.facsciences_planning_management.planning_service.entities.types.TimeSlot.CourseTimeSlot;
...
// public class CourseSchedulingRepositoryImpl implements
...
// @Override
// public boolean existsByAssignedCourseTeacherIdAndDayAndTimeSlot(String
...
// Aggregation.match(Criteria.where("courseDetails.teacher.$id").is(new
// ObjectId(teacherId))),
// Aggregation.limit(1));

// return !mongoTemplate.aggregate(aggregation,
// CourseScheduling.class).getMappedResults().isEmpty();
// }

// @Override
// public List<CourseScheduling> findByTimetableUsedTrue() {
// TypedAggregation<CourseScheduling> aggregation =
// Aggregation.newAggregation(CourseScheduling.class,
...
// );
// return mongoTemplate.aggregate(aggregation,
// CourseScheduling.class).getMappedResults();
// }

// @Override
// public List<CourseScheduling>
// findByAssignedCourseObsoleteFalseAndAssignedCourseUeLevelIdAndDayAndTimeSlot(
...
// Aggregation.match(Criteria.where("joinedUe.level").is(new
// ObjectId(levelId))),
// Aggregation.project("id", "day", "assignedCourse", "timeSlot", "room",
// "timetable", "createdAt",
...
// @Override
// public List<CourseScheduling>
// findByAssignedCourseObsoleteFalseAndAssignedCourseUeLevelIdAndDay(
...
// @Override
// public Page<CourseScheduling>
// findByAssignedCourseObsoleteFalseAndAssignedCourseUeLevelBranchId(
...
// Aggregation.match(Criteria.where("joinedBranch._id").is(new
// ObjectId(branchId))));
...
// .project("id", "day", "assignedCourse", "timeSlot", "room", "timetable",
// "createdAt", "updatedAt")
// .and("_id").as("id"));

// TypedAggregation<CourseScheduling> dataAggregation =
// Aggregation.newAggregation(CourseScheduling.class,
// dataPipeline);
// List<CourseScheduling> content = mongoTemplate.aggregate(dataAggregation,
// CourseScheduling.class)
// .getMappedResults();

// List<AggregationOperation> countPipeline = new ArrayList<>(basePipeline);
// countPipeline.add(Aggregation.count().as("total"));
// TypedAggregation<CountResult> countAggregation =
// Aggregation.newAggregation(CountResult.class, countPipeline);

// return PageableExecutionUtils.getPage(content, pageable,
// () -> Optional
// .ofNullable(mongoTemplate.aggregate(countAggregation, "course_schedules",
// CountResult.class)
...
// @Override
// public List<CourseScheduling>
// findByAssignedCourseObsoleteFalseAndAssignedCourseUeLevelIdAndTimeSlot(
