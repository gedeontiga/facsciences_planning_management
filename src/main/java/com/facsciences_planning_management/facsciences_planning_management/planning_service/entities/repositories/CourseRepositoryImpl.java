...
public class CourseRepositoryImpl implements CourseRepositoryCustom {
    ...
    @Override
    public Page<Course> findByObsoleteFalseAndUeLevelId(String levelId, Pageable page) {
        ...
        TypedAggregation<Course> countAggregation = Aggregation.newAggregation(Course.class, countOperations);
        AggregationResults<org.bson.Document> countResults = mongoTemplate.aggregate(countAggregation, "courses",
        ...
        TypedAggregation<Course> aggregation = Aggregation.newAggregation(Course.class, paginatedOperations);
        AggregationResults<Course> results = mongoTemplate.aggregate(aggregation, "courses", Course.class);

        return PageableExecutionUtils.getPage(results.getMappedResults(), page, () -> total);
    }
