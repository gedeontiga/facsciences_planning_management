...
// public class ExamSchedulingRepositoryImpl implements
...
// // @Override
// // public boolean existsByProctorIdAndSessionDateAndTimeSlot(String
// proctorId,
...
// // query.addCriteria(Criteria.where("proctor.$id").is(new
// ObjectId(proctorId))
...
// @Override
// public List<ExamScheduling>
// findByUeLevelIdAndSessionDateAndTimeSlotAndTimetableUsedTrue(
// String levelId, LocalDate sessionDate, TimeSlot.ExamTimeSlot timeSlot) {
// if (!ObjectId.isValid(levelId)) {
// return Collections.emptyList();
// }

// TypedAggregation<ExamScheduling> aggregation =
// Aggregation.newAggregation(ExamScheduling.class,
...
// ObjectId(levelId))),
// Aggregation.project("id", "proctor", "sessionDate", "ue", "timeSlot", "room",
// "timetable", "createdAt",
// "updatedAt").and("_id").as("id"));

// return mongoTemplate.aggregate(aggregation,
// ExamScheduling.class).getMappedResults();
// }

// @Override
// public List<ExamScheduling>
// findByUeLevelIdAndSessionDateAndTimetableUsedTrue(
...
// @Override
// public List<ExamScheduling> findByTimetableUsedTrueAndUeLevelId(String
// levelId) {
// if (!ObjectId.isValid(levelId)) {
// return Collections.emptyList();
// }
...
// ObjectId(levelId))),
// Aggregation
// .project("id", "proctor", "sessionDate", "ue", "timeSlot", "room",
// "timetable", "createdAt",
// "updatedAt")
// .and("_id").as("id"));
...
// @Override
// public Page<ExamScheduling> findByTimetableUsedTrueAndUeLevelBranchId(String
// branchId, Pageable pageable) {
...
// dataPipeline.add(Aggregation.project("id", "proctor", "sessionDate", "ue",
// "timeSlot", "room", "timetable",
// "createdAt", "updatedAt").and("_id").as("id"));

// TypedAggregation<ExamScheduling> dataAggregation =
// Aggregation.newAggregation(ExamScheduling.class,
// dataPipeline);
// List<ExamScheduling> content = mongoTemplate.aggregate(dataAggregation,
// ExamScheduling.class)
// .getMappedResults();
...
// () -> Optional
// .ofNullable(mongoTemplate.aggregate(countAggregation, "exam_schedules",
// CountResult.class)
