...
// import
// com.facsciences_planning_management.facsciences_planning_management.planning_service.entities.Room;
// import
...
// import
// com.facsciences_planning_management.facsciences_planning_management.planning_service.entities.repositories.RoomRepository;
// import
...
// import
// com.facsciences_planning_management.facsciences_planning_management.planning_service.managers.dtos.ExamSchedulingUpdateRequest;
// import
...
// import
// com.facsciences_planning_management.facsciences_planning_management.planning_service.managers.dtos.SimpleSchedulingUpdateRequest;
// import
...
// createSimpleScheduling(SimpleSchedulingCreateRequest request) {

// if (!roomService.isRoomAvailable(request.roomId(), request.startTime(),
// request.endTime(), request.day())) {
// throw new ResourceConflictException("Room is not available at the requested
// time");
// }
...
// Timetable timetable =
// timetableService.getTimetableEntityById(request.timetableId());
...
// @Override
// public ExamSchedulingDTO createExamScheduling(ExamSchedulingCreateRequest
// request) {

// if (!roomService.isRoomAvailableForDate(request.roomId(),
...
// List<SimpleScheduling> simpleSchedulings =
// simpleSchedulingRepository.findByRoomId(roomId);
// List<ExamScheduling> examSchedulings =
// examSchedulingRepository.findByRoomId(roomId);
...
// List<SimpleScheduling> simpleSchedulings =
// simpleSchedulingRepository.findByTeacherId(teacherId);
// List<ExamScheduling> examSchedulings =
// examSchedulingRepository.findByProctorId(teacherId);
...
// List<SimpleScheduling> simpleSchedulings =
// simpleSchedulingRepository.findByUeIdIn(ueIds);
// List<ExamScheduling> examSchedulings =
// examSchedulingRepository.findByUeIdIn(ueIds);
...
// default -> throw new IllegalArgumentException("Unknown scheduling type: " +
// type);
// }
// }

// @Override
// public SimpleSchedulingDTO updateSimpleScheduling(String id,
// SimpleSchedulingUpdateRequest request) {
// SimpleScheduling scheduling = simpleSchedulingRepository.findById(id)
// .orElseThrow(() -> new ResourceNotFoundException("Simple scheduling not found
// with id: " + id));

// boolean roomChanged = request.roomId() != null &&
// !request.roomId().equals(scheduling.getRoom().getId());
// boolean timeChanged = (request.startTime() != null &&
// !request.startTime().equals(scheduling.getStartTime())) ||
// (request.endTime() != null &&
// !request.endTime().equals(scheduling.getEndTime()));
// boolean dayChanged = request.day() != null && request.day() !=
// scheduling.getDay();
...
// Optional.of(request.roomId()).ifPresent(roomId ->
// scheduling.setRoom(roomRepository.findById(roomId)
// .orElseThrow(() -> new ResourceNotFoundException("Room not found"))));

// Optional.of(request.ueId()).ifPresent(ueId ->
// scheduling.setUe(ueService.getUeEntityById(ueId)));
// Optional.of(request.teacherId()).ifPresent(teacherId ->
// scheduling.setTeacher(userRepository.findById(teacherId)
// .orElseThrow(() -> new ResourceNotFoundException("Teacher not found"))));
...
// @Override
// public ExamSchedulingDTO updateExamScheduling(String id,
// ExamSchedulingUpdateRequest request) {
// ExamScheduling scheduling = examSchedulingRepository.findById(id)
// .orElseThrow(() -> new ResourceNotFoundException("Exam scheduling not found
// with id: " + id));
...
// scheduling.getStartTime(),
// request.endTime() != null ? request.endTime() : scheduling.getEndTime(),
// request.sessionDate() != null ? request.sessionDate() :
// scheduling.getSessionDate())) {
...
// @Override
// public boolean checkForSchedulingConflicts(SchedulingConflictCheckRequest
// request) {
